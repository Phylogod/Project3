...
library(devtools)
install_github("Phylogod/Project3/Project3")
```
...
library(leaflet)
```
To use this first function you must first develop a list of taxa that you want to search data for! Listed below is my example. Whatever you define this list will be the input after the function is defined.
...
After defining your function, you can now use the function based off the list you defined with taxa. I used "penguins".
